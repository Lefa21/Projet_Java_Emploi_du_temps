...
public class Salle {
    ...
    public boolean verifierDisponibilitePourCreneau(Creneau creneau) {
        System.out.println("Vérification de la disponibilité de la salle " + numeroSalle + " pour le créneau " + creneau.getIdentifiantCreneau());
